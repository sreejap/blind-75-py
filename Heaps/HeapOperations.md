...
heapq.heapify(lst) is for when you already have an arbitrary list of values and you want to transform it into a heap in-place.
In the article’s pattern, min_heap and max_heap start empty, e.g.:
self.min_heap = []
self.max_heap = []
